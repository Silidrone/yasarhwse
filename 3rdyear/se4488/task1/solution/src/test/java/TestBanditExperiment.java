...
public class TestBanditExperiment {
    ...
    void testConstantStepSize_SampleAvg_Comparison() throws IOException {
        ...
        // I assume by 0.9 epsilon is meant 0.1 according to my implementation as only then I get meaningful results
        comparisonExperiment.addPlayer(new RLBanditPlayer("Constant05", new ConstantStepSizeVE(0.0, 0.9), new EpsilonGreedyAC(0.1)));
        comparisonExperiment.addPlayer(new RLBanditPlayer("Constant09", new ConstantStepSizeVE(0.0, 0.5), new EpsilonGreedyAC(0.1)));
        comparisonExperiment.addPlayer(new RLBanditPlayer("SampleAverage", new SampleAverageVE(0.9), new EpsilonGreedyAC(0.1)));
    ...
    void testUpperConfidenceBoundsComparison() throws IOException {
        ...
        comparisonExperiment.addPlayer(new RLBanditPlayer("UCBGreedy", new UpperConfidenceBoundVE(0.0, 5.0), new GreedyAC()));
